"""Script to run PE run using dynesty sampler for modified TaylorF2 model keeping distance and iota fixed to their MAP values
...
def prior_transform(cube):
    ...
    cube[4] = k_min + (k_max - k_min) * cube[4]                   # tc: uniform prior
    cube[5] = tc_min + (tc_max - tc_min) * cube[5] # pol: uniform angle
