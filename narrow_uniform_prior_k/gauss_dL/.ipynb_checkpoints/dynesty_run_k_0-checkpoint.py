"""Script to run PE run using dynesty sampler for TaylorF2 model with a gaussian prior on distance (from EM counterpart)
...
file.create_dataset('iota', data=res['samples'][:,4])
file.create_dataset('distance', data=res['samples'][:,5])
file.create_dataset('tc', data=res['samples'][:,6])
