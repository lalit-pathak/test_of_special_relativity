...
from utils import cdfinv, cdfinv_q
...
mu_k, var_k = 0, (4e-7)**2
k_min, k_max = -1e-5, 1e-5
mu_distance, var_distance = 40.7, 3.3**2
...
def prior_transform(cube):
    ...
    cube[4] = cdfinv(mu_k, var_k, k_min, k_max, cube[4])           # s2z: uniform prior
    cube[5] = np.arccos(2*cube[5] - 1) 
    cube[6] = cdfinv(mu_distance, var_distance, distance_min, distance_max, cube[6])  # distance: unifrom prior in dL**3
